<nav class="navbar navbar-expand-lg navbar-light bg-light" id="iw-nav">
  <a class="navbar-brand" href="https://transparency.cz/" target="_blank"><img src="./images/Logo_TI_CZ_clear.png" alt="" /> </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a href="./index.php" class="nav-link" :class="{active: page == 'parties'}">Strany</a>
      </li>
      <li class="nav-item">
        <a href="./donors.php" class="nav-link" :class="{active: page == 'donors'}">Dárci</a>
      </li>
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <a href="./about" class="nav-link nav-link-about">O webu</a>
      </li>
    </ul>
  </div>
</nav>